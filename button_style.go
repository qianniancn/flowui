...
func (b ButtonWidget) style(theme *Theme, clickable *widget.Clickable) buttonStyle {
...
func buttonSizeStyle(theme *Theme, size ButtonSize, iconOnly bool) buttonStyle {
	style := buttonStyle{
...
func buttonSpinnerSize(theme *Theme, size ButtonSize) unit.Dp {
	switch size {
	case ButtonSmall:
...
func buttonColors(theme *Theme, variant ButtonVariant) buttonPalette {
