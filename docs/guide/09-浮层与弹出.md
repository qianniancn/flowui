...
// 受控：Modal/Popover 等构造族把 open 值传给构造函数，
// 关闭请求经 OnOpenChange 回传（没有 .Open()/.DefaultOpen() 方法）
ui.Modal("confirm", m.DialogOpen, "标题", body).OnOpenChange(func(o bool) {
	send(SetDialog(o))
})
```
