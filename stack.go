...
func (s StackWidget) Layout(ctx *Context, gtx layout.Context) layout.Dimensions {
...
func layoutStackLayer(ctx *Context, gtx layout.Context, layer StackLayer) stackLayerLayout {
