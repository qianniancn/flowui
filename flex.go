...
func (c CenterWidget) Layout(ctx *Context, gtx layout.Context) layout.Dimensions {
...
func (c ColumnWidget) Layout(ctx *Context, gtx layout.Context) layout.Dimensions {
...
func (r RowWidget) Layout(ctx *Context, gtx layout.Context) layout.Dimensions {
...
func (f FlexWidget) Layout(ctx *Context, gtx layout.Context) layout.Dimensions {
	return f.child.Layout(ctx, gtx)
}

func flexLayout(ctx *Context, gtx layout.Context, axis layout.Axis, gap unit.Dp, align layout.Alignment, widgets []Widget) layout.Dimensions {
